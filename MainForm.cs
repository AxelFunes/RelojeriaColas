        ...
        private void CargarTabla(List<Queue> queues)
        {
            ...
            BindingSource bindingLastQueueSource = new BindingSource
            {
                DataSource = new
                {
                    ...
                    Rnd_cafe = lastQueue.Coffee is null ? "-" : lastQueue.Coffee.RndCafe.ToString(),
                    Fin_cafe = lastQueue.Coffee is null ? "-" : lastQueue.Coffee.FinCafe.ToString(),
            ...
            BindingSource bindingQueuesSource = new BindingSource
            {
                DataSource = queues.Select(row => new {
                    ...
                    Rnd_cafe = row.Coffee is null ? "-" : row.Coffee.RndCafe.ToString(),
                    Fin_cafe = row.Coffee is null ? "-" : row.Coffee.FinCafe.ToString(),
